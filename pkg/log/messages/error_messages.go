...
const CSPFK019E string = "CSPFK019E Failed to load in-cluster Kubernetes client config. Reason: %s"
const CSPFK020E string = "CSPFK020E Failed to retrieve k8s secret. Reason: %s"
const CSPFK021E string = "CSPFK021E Failed to retrieve k8s secrets"
const CSPFK022E string = "CSPFK022E Failed to patch k8s secret. Reason: %s"
const CSPFK023E string = "CSPFK023E Failed to patch K8s secrets"
const CSPFK024E string = "CSPFK024E Failed to create stringDataEntry"
