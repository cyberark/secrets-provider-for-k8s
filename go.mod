...
replace golang.org/x/net v0.0.0-20210503060351-7fd8e65b6420 => golang.org/x/net v0.24.0
...
replace golang.org/x/net v0.1.1-0.20221104162952-702349b0e862 => golang.org/x/net v0.24.0

replace golang.org/x/text v0.0.0-20170915032832-14c0d48ead0c => golang.org/x/text v0.4.0

replace golang.org/x/net v0.4.0 => golang.org/x/net v0.24.0

replace golang.org/x/net v0.6.0 => golang.org/x/net v0.24.0

replace golang.org/x/net v0.10.0 => golang.org/x/net v0.24.0

replace golang.org/x/net v0.21.0 => golang.org/x/net v0.24.0

replace golang.org/x/net v0.0.0-20220425223048-2871e0cb64e4 => golang.org/x/net v0.24.0
