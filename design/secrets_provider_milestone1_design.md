...
| 2.2  | `K8S_SECRETS_LABELS` with value                              | - `K8S_SECRETS_LABELS` env variable configured with value    | Secrets Provider runs as a Job                               | Failure because no secret exists with that label<br />- Failure is logged |                                            |
